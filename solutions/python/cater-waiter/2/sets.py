...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    category = "Cocktail" if set(drink_ingredients) & set(ALCOHOLS) else "Mocktail"
    return f"{drink_name} {category}"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for diet_name, ingredients in diets.items():
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    return {ingredient for dish in dishes for ingredient in dish - intersection}
